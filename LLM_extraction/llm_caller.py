...
def call_ollama(response_model, content_prompt: str, model_name: str = 'llama3.1:8b', temp: int = 0):
    ...
    format=response_model.model_json_schema(),  # Use Pydantic to generate the schema or format=schema
